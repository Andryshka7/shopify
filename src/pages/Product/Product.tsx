...
import { pushCartItems } from 'redux/features/cart'
...
const Product = () => {
	...
	const { productList, loading } = useAppSelector((store) => store.products)
	...
	const { image, id, title, description, price, rating } = product
